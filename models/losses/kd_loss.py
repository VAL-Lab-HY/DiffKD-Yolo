...
class KDLoss():
    ...
    def __call__(self, x, targets):
        # FIX: Resize input cho Teacher về 256x256 (Pretrained chuẩn)
        with torch.no_grad():
